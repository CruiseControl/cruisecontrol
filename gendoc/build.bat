...
set ANT_CLASSPATH=../main/lib/ant/ant-launcher.jar;../main/lib/junit-3.8.2.jar;../main/lib/xercesImpl-2.8.0.jar;../main/lib/xml-apis-2.8.0.jar;%CLOVER_HOME%/lib/clover.jar
echo %ANT_CLASSPATH%
