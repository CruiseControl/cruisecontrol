<%@page contentType="text/html" import="net.sourceforge.cruisecontrol.*, net.sourceforge.cruisecontrol.chart.*"%>
...
<hr />
<jsp:useBean id="pieData" class="demo.PieChartData" />
...
<hr />
<jsp:useBean id="chartData" class="demo.TimeChartData" />
